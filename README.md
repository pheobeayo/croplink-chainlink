  ...
  <h1>CropLink</h1>
  <p>
    <strong>An AgroTech Dapp with weather-savvy smart contracts for bountiful selling</strong>
  </p>
...
CropLink simplifies the onboarding process for farmers, who only need a Metamask account to get started, currently operating on the [Sepolia Testnet](https://sepolia.etherscan.io/) and [polygon Testnet](https://mumbai.polygonscan.com/address/0xA263a854987B5E5EFd20c6F6D2626e64F94F8a46). With the help of Chainlink oracles and Chainlink Functions, CropLink constantly monitors weather conditions using [Chainlink Automation](https://automation.chain.link/sepolia/114001039620633922857382056558929487684700095749380182898698714510233703329294) and it also monitors Price feed with chainlink fucntions  [Chainlink Functions](https://functions.chain.link/mumbai/914), in the event of high temperatures or other adverse conditions that could potentially damage crops, the smart contracts activate automatically. This mechanism enables farmers to sell their crops to registered buyers at a fair price, ensuring they don't bear the brunt of nature's unpredictability.
...
```
git clone https://github.com/max-clinch/croplink.git
```
...
1. Fork the repository to your own GitHub account: https://github.com/max-clinch/croplink.git
